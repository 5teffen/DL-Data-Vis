...
def transition_line(p1, p2, no_points, vertices, path, highlight = False):
	out_path = "images/pic"
	path = "images/transitions" + path
	x1,y1,z1 = p1
	x2,y2,z2 = p2
	...
	for n in range(1,int(no_points)+1):
		...
		duration = 20
		if (highlight) and (cluster != prev_cluster):
...
def gif_points(points, filename, duration = 20):  # Creates a GIF out of specified points
	images = []
...
if __name__ == '__main__':
	...
	# transition_line([-10.49,-12.40,-7.08], [2.99,12.26,12.46] , 50.0, c10, "testing.gif")


	transition_line([-10.49,-8,-3], [2.99,-8,-3] , 100.0, c10, "x_low.gif", True)
	transition_line([-10.49,0,2], [2.99,0,2] , 100.0, c10, "x_mid.gif", True)
	transition_line([-10.49,10,10], [2.99,10,10] , 100.0, c10, "x_high.gif", True)

	transition_line([-6,-12.40,-3], [-6,12.26,-3] , 100.0, c10, "y_low.gif", True)
	transition_line([-2,-12.40,2], [-2,12.26,2] , 100.0, c10, "y_mid.gif", True)
	transition_line([0,-12.40,10], [0,12.26,10] , 100.0, c10, "y_high.gif", True)

	transition_line([-6,-8,-7.08], [-6,-8,12.46] , 100.0, c10, "z_low.gif", True)
	transition_line([-2,0,-7.08], [-2,0,12.46] , 100.0, c10, "z_mid.gif", True)
	transition_line([0,10,-7.08], [0,10,12.46] , 100.0, c10, "z_high.gif", True)
