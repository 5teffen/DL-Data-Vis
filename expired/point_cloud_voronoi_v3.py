...
def point_cloud(border_lines, equation, density = 2):
	...
	# 				max_x = max(max_x,point1[0],point1[0])
	# 				min_x = min(min_x,point1[0],point1[0])
	# 				max_y = max(max_y,point1[1],point1[1])
	# 				min_y = min(min_y,point1[1],point1[1])
	# 				max_z = max(max_z,point1[2],point1[2])
	# 				min_z = min(min_z,point1[2],point1[2])
	# 				# result += point_line(point1,point2,label)
